...
# ---------------- Load Files -----------------
overall = pd.read_csv('data_overall.csv')
stations = pd.read_csv('data_stations.csv')
y_2017 = pd.read_csv('data_17.csv')
y_2018 = pd.read_csv('data_18.csv')
y_2019 = pd.read_csv('data_19.csv')
y_2020 = pd.read_csv('data_20.csv')
y_2021 = pd.read_csv('data_21.csv')
